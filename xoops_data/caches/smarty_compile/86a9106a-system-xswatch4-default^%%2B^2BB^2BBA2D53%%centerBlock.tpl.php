<?php /* Smarty version 2.6.32, created on 2022-11-02 15:39:38
         compiled from xswatch4/tpl/centerBlock.tpl */ ?>
<?php if ($this->_tpl_vars['xoBlocks']['page_topcenter']): ?>
    <div class="col-12">
        <?php $_from = $this->_tpl_vars['xoBlocks']['page_topcenter']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
