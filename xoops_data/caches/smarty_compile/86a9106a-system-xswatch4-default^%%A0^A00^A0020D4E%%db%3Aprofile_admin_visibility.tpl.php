...
">
        <?php $_from = $this->_tpl_vars['addform']['elements']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
">
            ...
            <td>
                <?php if (isset ( $this->_tpl_vars['visibilities'][$this->_tpl_vars['field_id']] )): ?>
                    <ul>
                        <?php $_from = $this->_tpl_vars['visibilities'][$this->_tpl_vars['field_id']]; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
