...
<table>
    ...
    <?php $_from = $this->_tpl_vars['steps']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
"><img
                            src="<?php 
echo 'http://localhost/Frameworks/moduleclasses/icons/16/'; ?><?php echo $this->_tpl_vars['step']['step_save']; ?>
