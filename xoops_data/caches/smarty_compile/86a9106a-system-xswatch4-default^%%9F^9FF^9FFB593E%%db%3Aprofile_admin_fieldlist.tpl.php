...
<form action="field.php" method="post" id="fieldform">
    <table>
        ...
        <?php $_from = $this->_tpl_vars['fieldcategories']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['category']):
?>
            <?php $_from = $this->_tpl_vars['category']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
"><img
                                        src="<?php 
echo 'http://localhost/Frameworks/moduleclasses/icons/16/'; ?><?php echo $this->_tpl_vars['field']['field_required']; ?>
...
"><img src="<?php 
echo 'http://localhost/Frameworks/moduleclasses/icons/16/edit.png'; ?>"
                                                                                                            alt="<?php echo @_EDIT; ?>
"
                                                                                                            title="<?php echo @_EDIT; ?>
"/></a>
...
"><img
                                        src="<?php 
echo 'http://localhost/Frameworks/moduleclasses/icons/16/delete.png'; ?>" alt="<?php echo @_DELETE; ?>
" title="<?php echo @_DELETE; ?>
"</a>
                        <?php endif; ?>
                    </td>
